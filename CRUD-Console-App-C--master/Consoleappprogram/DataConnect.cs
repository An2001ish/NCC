...
namespace Consoleappprogram
{
    internal class DataConnect
    {
        public static void Main(string[] args)
        {
            ...
            {
                conn.ConnectionString = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=AnishBaraily;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False";

                try
                {
                    conn.Open();
                    Console.WriteLine("Anish Baraily");
                    Console.WriteLine("Connection Opened");

                    Console.WriteLine("Choose an operation:");
                    Console.WriteLine("1. Create new user");
                    Console.WriteLine("2. Read existing user");
                    Console.WriteLine("3. Update any user");
